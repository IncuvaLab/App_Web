					...
					<tbody>
						<tr>
							<td align="center">
								...
								<table id="intro" cellpadding="0" cellspacing="0" border="0" bgcolor="#4F6331" align="center" style="width: 100%; padding: 0; margin: 0; background-image: url(https://images.pexels.com/photos/733852/pexels-photo-733852.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1); background-size: auto 102%; background-position: center center; background-repeat: no-repeat; background-color: #080e02">
									<tbody >
														...
														<tr>
															...
															<td align="center">
																<div border="0" style="border: none; height: 60px;">
																	<p style="font-size: 18px; line-height: 24px; font-family: Verdana, Geneva, sans-serif; color: #444857; text-align: center; mso-table-lspace:0;mso-table-rspace:0;">
                                                                         El docente <strong style=" color: #4A0026;">{!! $teacherName !!}</strong> aprobó tu formulario de   <strong  style=" color: #4A0026;">{!! $form !!}</strong>. <br> <br>
                                                                        Ya puedes pasar a la siguiente etapa.
                                                                    <br>
																	<br>
